...
class JobType extends ConsumerStatefulWidget {
  final VoidCallback? onNext;
  final VoidCallback? onBack;
  const JobType({super.key, this.onNext, this.onBack});

  @override
  _JobTypeState createState() => _JobTypeState();
}

class _JobTypeState extends ConsumerState<JobType> {
  String _selected = '';
              ...
              PressEffect(
                onPressed: () {
                  if (_selected.isNotEmpty) {
                    ...
                    profile.updateJobType(_selected);
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color:
                        _selected.isNotEmpty ? Colors.black : Color(0xffa3a3a3),
                    borderRadius: BorderRadius.circular(30),
                    border: Border.all(
