...
class CompanyName extends ConsumerStatefulWidget {
  final VoidCallback? onNext;
  final VoidCallback? onBack;
  const CompanyName({super.key, this.onNext, this.onBack});

  @override
  _CompanyNameState createState() => _CompanyNameState();
}

class _CompanyNameState extends ConsumerState<CompanyName> {
              ...
              PressEffect(
                onPressed: () {
                  ...
                  if (_isValid) {
                    ...
                    profile.updateCompanyName(_cNameController.text);
