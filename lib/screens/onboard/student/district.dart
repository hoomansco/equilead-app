...
class District extends ConsumerStatefulWidget {
  final VoidCallback? onNext;
  final VoidCallback? onBack;
  const District({super.key, this.onNext, this.onBack});

  @override
  _DistrictState createState() => _DistrictState();
}

class _DistrictState extends ConsumerState<District> {
  String _selected = '';
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Select your college’s district",
                    style: TextStyle(
                      fontSize: 20,
              ...
              PressEffect(
                onPressed: () {
                  ...
                  if (_selected.isNotEmpty) {
                    ...
                    profile.updateDistrict(_selected);
                    var colleges = ref.read(collegeProvider);
                    var collegeDistrictP =
                        ref.read(collegeDistrictProvider.notifier);
                    collegeDistrictP.filterCollegesByDistrict(
                        colleges, _selected.toLowerCase());
